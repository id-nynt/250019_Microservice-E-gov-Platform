...
namespace CourseSearch.Data
{
...

    {
        public void Configure(EntityTypeBuilder<Course> builder)
        {
            ...
            new Course { CourseCode = "HLT800", CourseName = "Certificate IV in Allied Health Assistance", Level = "Certificate IV", CourseArea = "Health", Location = "Sydney", StudyOption = "Full time", Duration = "12 months", EstimatedFee = 5200m },
            new Course { CourseCode = "HLT801", CourseName = "Diploma of Paramedical Science", Level = "Diploma", CourseArea = "Health", Location = "Brisbane", StudyOption = "Part time", Duration = "18 months", EstimatedFee = 10500m },
            ...
            new Course { CourseCode = "TRD61", CourseName = "Certificate IV in Building and Construction", Level = "Certificate IV", CourseArea = "Trades", Location = "Brisbane", StudyOption = "Part time", Duration = "18 months", EstimatedFee = 9500m },
            ...
            new Course { CourseCode = "TRD63", CourseName = "Certificate III in Painting and Decorating", Level = "Certificate III", CourseArea = "Trades", Location = "Adelaide", StudyOption = "Part time", Duration = "12 months", EstimatedFee = 6000m },
            ...
            new Course { CourseCode = "TRD65", CourseName = "Certificate IV in Refrigeration and Air Conditioning", Level = "Certificate IV", CourseArea = "Trades", Location = "Perth", StudyOption = "Full time", Duration = "24 months", EstimatedFee = 14000m },
            new Course { CourseCode = "TRD66", CourseName = "Certificate III in Joinery", Level = "Certificate III", CourseArea = "Trades", Location = "Wollongong", StudyOption = "Full time", Duration = "12 months", EstimatedFee = 6500m },
            new Course { CourseCode = "TRD67", CourseName = "Diploma of Engineering Trades", Level = "Diploma", CourseArea = "Trades", Location = "Melbourne", StudyOption = "Part time", Duration = "24 months", EstimatedFee = 14500m },
            ...
            new Course { CourseCode = "TRD69", CourseName = "Certificate II in Automotive Air Conditioning", Level = "Certificate II", CourseArea = "Trades", Location = "Sydney", StudyOption = "Full time", Duration = "6 months", EstimatedFee = 4000m },
            ...
            new Course { CourseCode = "HOSP07", CourseName = "Certificate III in Patisserie", Level = "Certificate III", CourseArea = "Hospitality", Location = "Melbourne", StudyOption = "Full time", Duration = "12 months", EstimatedFee = 6500m },
            ...
            new Course { CourseCode = "HOSP09", CourseName = "Certificate IV in Hospitality Management", Level = "Certificate IV", CourseArea = "Hospitality", Location = "Brisbane", StudyOption = "Full time", Duration = "18 months", EstimatedFee = 9800m },
            ...
            new Course { CourseCode = "HOSP13", CourseName = "Certificate II in Food and Beverage", Level = "Certificate II", CourseArea = "Hospitality", Location = "Sydney", StudyOption = "Full time", Duration = "6 months", EstimatedFee = 3000m },
            ...
            new Course { CourseCode = "CREA7", CourseName = "Certificate IV in Acting and Performance", Level = "Certificate IV", CourseArea = "Creative Arts", Location = "Sydney", StudyOption = "Part time", Duration = "12 months", EstimatedFee = 6500m },
            new Course { CourseCode = "CREA8", CourseName = "Bachelor of Music Production", Level = "Bachelor", CourseArea = "Creative Arts", Location = "Melbourne", StudyOption = "Full time", Duration = "36 months", EstimatedFee = 28000m },
            new Course { CourseCode = "CREA9", CourseName = "Certificate III in Digital Illustration", Level = "Certificate III", CourseArea = "Creative Arts", Location = "Canberra", StudyOption = "Full time", Duration = "9 months", EstimatedFee = 5000m },
            ...
            new Course { CourseCode = "CREA11", CourseName = "Master of Fine Arts", Level = "Master", CourseArea = "Creative Arts", Location = "Sydney", StudyOption = "Full time", Duration = "24 months", EstimatedFee = 24000m },
            new Course { CourseCode = "CREA12", CourseName = "Certificate IV in Game Art", Level = "Certificate IV", CourseArea = "Creative Arts", Location = "Brisbane", StudyOption = "Part time", Duration = "12 months", EstimatedFee = 6500m },
            ...
            new Course { CourseCode = "CREA15", CourseName = "Certificate III in Creative Writing", Level = "Certificate III", CourseArea = "Creative Arts", Location = "Wollongong", StudyOption = "Self-paced", Duration = "9 months", EstimatedFee = 4000m },
            ...
            new Course { CourseCode = "BUS602", CourseName = "Certificate IV in Small Business Management", Level = "Certificate IV", CourseArea = "Business and Administration", Location = "Melbourne", StudyOption = "Part time", Duration = "12 months", EstimatedFee = 4800m },
            new Course { CourseCode = "BUS603", CourseName = "Master of International Business", Level = "Master", CourseArea = "Business and Administration", Location = "Canberra", StudyOption = "Full time", Duration = "24 months", EstimatedFee = 33000m },
            ...
            new Course { CourseCode = "BUS605", CourseName = "Certificate IV in Marketing and Communications", Level = "Certificate IV", CourseArea = "Business and Administration", Location = "Adelaide", StudyOption = "Full time", Duration = "12 months", EstimatedFee = 5200m },
            new Course { CourseCode = "BUS606", CourseName = "Bachelor of Accounting", Level = "Bachelor", CourseArea = "Business and Administration", Location = "Sydney", StudyOption = "Full time", Duration = "36 months", EstimatedFee = 30000m },
            new Course { CourseCode = "BUS607", CourseName = "Diploma of E-Commerce", Level = "Diploma", CourseArea = "Business and Administration", Location = "Melbourne", StudyOption = "Full time", Duration = "18 months", EstimatedFee = 10000m },
            new Course { CourseCode = "BUS608", CourseName = "Certificate III in Business Operations", Level = "Certificate III", CourseArea = "Business and Administration", Location = "Brisbane", StudyOption = "Part time", Duration = "9 months", EstimatedFee = 3500m },
            ...
            new Course { CourseCode = "BUS611", CourseName = "Certificate IV in Project Coordination", Level = "Certificate IV", CourseArea = "Business and Administration", Location = "Perth", StudyOption = "Part time", Duration = "12 months", EstimatedFee = 4700m },
            ...
            new Course { CourseCode = "AG06", CourseName = "Certificate II in Rural Operations", Level = "Certificate II", CourseArea = "Agriculture", Location = "Regional NSW", StudyOption = "Full time", Duration = "9 months", EstimatedFee = 3000m },
            new Course { CourseCode = "AG07", CourseName = "Diploma of Viticulture", Level = "Diploma", CourseArea = "Agriculture", Location = "Adelaide", StudyOption = "Part time", Duration = "18 months", EstimatedFee = 8500m },
            ...
            new Course { CourseCode = "AG09", CourseName = "Certificate IV in Wool Classing", Level = "Certificate IV", CourseArea = "Agriculture", Location = "Melbourne", StudyOption = "Full time", Duration = "12 months", EstimatedFee = 5500m },
            new Course { CourseCode = "AG10", CourseName = "Bachelor of Animal Science", Level = "Bachelor", CourseArea = "Agriculture", Location = "Sydney", StudyOption = "Full time", Duration = "36 months", EstimatedFee = 28000m },
            new Course { CourseCode = "AG11", CourseName = "Diploma in Organic Farming", Level = "Diploma", CourseArea = "Agriculture", Location = "Regional QLD", StudyOption = "Full time", Duration = "18 months", EstimatedFee = 9000m },
            ...
            new Course { CourseCode = "AG13", CourseName = "Certificate III in Agricultural Machinery", Level = "Certificate III", CourseArea = "Agriculture", Location = "Adelaide", StudyOption = "Full time", Duration = "12 months", EstimatedFee = 6000m },
            new Course { CourseCode = "AG14", CourseName = "Certificate IV in Aquaculture", Level = "Certificate IV", CourseArea = "Agriculture", Location = "Perth", StudyOption = "Full time", Duration = "12 months", EstimatedFee = 6500m },
            new Course { CourseCode = "AG15", CourseName = "Master of Sustainable Agriculture", Level = "Master", CourseArea = "Agriculture", Location = "Canberra", StudyOption = "Full time", Duration = "24 months", EstimatedFee = 20000m }
